...
export const Layouts = {
  ANSI: [
    [
      ...
      { keyCode: KeyCodes.Backspace, size: "2U", label: "←" },
    ],
    [
      { keyCode: KeyCodes.Tab, size: "1.5U", label: "↹" },
      ...
      { keyCode: KeyCodes.Backslash, size: "1.5U", label: "\\" },
    ],
    [
      { keyCode: KeyCodes.CapsLock, size: "1.75U", label: "⇪" },
      ...
      { keyCode: KeyCodes.Enter, size: "2.25U", label: "↵" },
    ],
    [
      { keyCode: KeyCodes.ShiftLeft, size: "2.25U", label: "⇧" },
      ...
      { keyCode: KeyCodes.ShiftRight, size: "2.75U", label: "⇧" },
    ],
    [
      { keyCode: KeyCodes.Fn, size: "1.25U", label: "Fn" },
      { keyCode: KeyCodes.ControlLeft, size: "1.25U", label: "Ctrl" },
      { keyCode: KeyCodes.MetaLeft, size: "1.25U", label: "Super" },
      { keyCode: KeyCodes.AltLeft, size: "1.25U", label: "Alt" },
      { keyCode: KeyCodes.Space, size: "6.25U", label: "Space" },
      { keyCode: KeyCodes.MetaRight, size: "1.25U", label: "Super" },
      { keyCode: KeyCodes.AltRight, size: "1.25U", label: "Alt" },
      { keyCode: KeyCodes.ControlRight, size: "1.25U", label: "Ctrl" },
    ],
  ],
};
